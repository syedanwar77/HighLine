...
$global_host = "smtpout.secureserver.net"; //eg: Gmail Host => smtp.gmail.com 
$global_email = "info@highlinehomedecor.com";
$global_password = "#Access125#";
...
elseif(isset($_POST['send_newsletter']))
{
    ...
    else
    {
        ...
        $mail->Body = newslettertemplate($website_link, $email);
        $mail->send();
        if($mail->send())
        {
            $_SESSION['status'] = "We appreciate you contacting us. One of our colleagues will get back in touch with you soon! Have a great day!";
